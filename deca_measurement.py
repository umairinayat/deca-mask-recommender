...
# Add DECA folder to path so decalib can be imported
_DECA_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'DECA')
if _DECA_PATH not in sys.path:
    sys.path.insert(0, _DECA_PATH)
